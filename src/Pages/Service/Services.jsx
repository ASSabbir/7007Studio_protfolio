  ...
  const gigServices = [
    {
      ...
      description: "High-quality 3D product visualization with smooth rotations and dynamic lighting effects.",
      category: "Commercial",
      duration: "3-5 days",
    ...
    },
    {
      id: 2,
      name: "Logo Animation",
      description: "Eye-catching animated logos that bring your brand identity to life with professional motion design.",
      category: "Branding",
      duration: "2-3 days",
    ...
    },
    {
      ...
      description: "Professional character rigging for animations with full body controls and facial expressions.",
      category: "Character",
      duration: "5-7 days",
    ...
    },
    {
      ...
      description: "Dynamic motion graphics for social media, presentations, and digital marketing campaigns.",
      category: "Marketing",
      duration: "3-4 days",
  ...
  const customServices = [
    {
      ...
      description: "Complete 3D animated explainer videos tailored to your business needs with custom storytelling.",
      category: "Corporate",
      duration: "2-3 weeks",
      price: "Custom Quote",
    ...
    },
    {
      ...
      description: "Photorealistic architectural visualizations with cinematic camera movements and lighting.",
    ...
    },
    {
      ...
      description: "Complete game-ready 3D assets from concept to final optimization for any game engine.",
      category: "Gaming",
      duration: "2-6 weeks",
      price: "Custom Quote",
    ...
    },
    {
      ...
      description: "Professional visual effects integration with live-action footage for films and commercials.",
      category: "Film/TV",
      duration: "4-8 weeks",
      price: "Custom Quote",
          ...
          <div className="space-y-2 mb-6">
            {service.features.map((feature, idx) => (
              ...
              >
                ...
                <span className="text-gray-500 font-dmsans text-sm">{feature}</span>
              </motion.div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-6 pt-6 border-t border-red-900/30">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-sm text-white font-dmsans">{service.duration}</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-sm text-white font-dmsans">{service.price}</p>
              </div>
            </div>
          </div>
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-400 font-dmsans text-lg mb-8 max-w-2xl mx-auto">
            Let's bring your ideas to life with cutting-edge 3D animation technology.
          </p>
          <motion.button
