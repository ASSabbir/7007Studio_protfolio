          ...
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="relative">
                ...
                <div className="text-3xl md:text-5xl font-bold text-red-500 mb-2 tracking-wider">
...
const ClientReview = () => {
  ...
  return (
    <div className="min-h-screen text-white overflow-hidden">
      {/* Hero Banner */}
      <div id='banner-page' className="relative h-screen overflow-hidden top-0 font-bold">
        <MockVideo />
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }} className="relative pt-40 md:pt-60 pb-16 px-4 md:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <motion.h1 initial={{ y: 50, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.8, delay: 0.3 }} className="text-7xl md:text-6xl lg:text-9xl font-bold mb-6 tracking-wide">
              Client<span className="text-red-500"> Testimonials</span>
            </motion.h1>
            <motion.p initial={{ y: 30, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.8, delay: 0.5 }} className="text-gray-300 text-lg md:text-xl max-w-3xl mx-auto tracking-wider leading-relaxed">
        ...
        <div className="grid grid-cols-[1fr_200px]">
          ...
          <div className="relative border-t-2 border-l-2 border-gray-700 flex items-center justify-center p-4">
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-24 h-24 rounded-full bg-gradient-to-br from-red-500/20 to-red-800/20 blur-2xl animate-pulse" />
            </div>
